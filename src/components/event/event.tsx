...
export class Event {
    ...
    render() {
        return (
            <article class="relative font-medium bg-[#fef2ec] rounded-xl p-8 w-full flex flex-col justify-start max-w-[480px] lg:h-full dark:bg-[#22181c]">
                ...
                <div class="h-full flex flex-col justify-between">
                    ...
                    <div>
                        ...
                        {/* author/host link */}
                        <p class="mb-2 md:text-base xl:text-lg">
                            By{' '}
                            <a
                                class="font-semibold text-[#da4167]"
                                target="_blank"
                                rel="noopener"
                                href={this.eventDetails.meta.link}
                            >
                                {this.eventDetails.meta.host}
                            </a>
                        </p>
                    ...
                    <div>
                        ...
                        <div class="flex">
                            <a
                                href={this.eventDetails.link}
                                class="text-xs text-white font-medium bg-[#8D29DC] px-3 py-2 rounded-lg flex space-x-1 items-center transition-colors hover:bg-[#651A9E]"
                            >
