...
export class Header {
    ...
    render() {
        return (
            <header class="absolute z-50 w-full py-7 px-7 font-semibold text-[#775563] dark:text-[#AA8896]">
                <div class="container mx-auto flex items-center justify-between">
                    ...
                    <div class="bg-[#F8DDE4] rounded-t-full rounded-b-[145rem] h-20 fixed bottom-10 left-7 right-7 md:w-full md:static md:bg-transparent md:flex justify-center dark:bg-[#302127] md:dark:bg-transparent">
                        ...
                        <div class="absolute w-full bottom-16 flex justify-center">
                            <a
                                class="bg-[#F8DDE4] rounded-tl-[40px] rounded-tr-[40px] p-2 w-24 flex justify-center md:hidden dark:bg-[#302127]"
                                href={links.invite}
                            >
                        ...
                        <nav class="flex items-center justify-center h-full space-x-8 text-xs">
                            {pages.map(page => (
                                <a
                                    class="flex flex-col items-center justify-center space-y-1 transition-colors hover:text-[#000000] dark:hover:text-white"
                                    href={page.link}
                                >
                    ...
                    <div class="hidden md:flex items-center justify-end w-full">
                        ...
                        <a
                            ...
                            target="blank"
                            rel="noopener"
                            class="mx-2 hidden transition-colors lg:inline hover:text-black dark:hover:text-white"
                        ...
                        {/* join button */}
                        <a
                            class="mx-4 text-white font-semibold bg-[#8D29DC] px-4 py-2 rounded-lg flex space-x-2 items-center transition-colors hover:bg-[#651A9E]"
                            href={links.invite}
                        >
